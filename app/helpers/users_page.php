...
class Users_page
{
    ...
    public static function SideBarTemplate($title)
    {
        ...
        //creamos un arreglo donde 1 = asesor financiero , y 2 = administrador
        $permisos = array(
            'dashboard.php' => array(1, 2),
            'accounts.php' => array(2),
            'users.php' => array(2),
            'customers.php' => array(1, 2),
            'loans.php' => array(1, 2),
            'payments.php' => array(1)
        ...
        // Verificamos si el usuario tiene permisos para acceder a esta página
        if (!in_array($_SESSION['tipo_usuario'], $permisos[$archivo_actual])) {
            // Si el usuario no tiene permisos para acceder a esta página, lo redirigimos a la página de inicio
            header("Location: ../../resources/error/403.html");
            exit();
        }
        ...
        if (isset($_SESSION['id_usuario'])) {
                    ...
                    <header>
                        <div class="image-text">
                            ...
                            <div class="text logo-text">
                                ...
                                <span style="font-size: 14px !important">Asesor financiero</span>
                ...
                print '
                    ...
                    <header>
                        <div class="image-text">
                            ...
                            <div class="text logo-text">
                                <span class="name">' . $_SESSION['username'] . '</span>
                                <span style="font-size: 14px !important">Administrador</span>
            ...
            if ($filename != 'index.php' && $filename != 'first_time_register.php') {
            } else {
    ...
    public static function footerTemplate($controller)
    {
        ...
        <!-- Modal -->
            ...
            <div class="modal-dialog modal-dialog-centered  modal-lg">
                ...
                <script src="../../app/controllers/user/' . $controller . '"></script>
                <script src="../../app/controllers/user/account.js"></script>
