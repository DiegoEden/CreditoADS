...
Customer_page::SideBarTemplate('CreditoADS | Transferencias')
?>
...
<div class="page-content p-3   animate__animated animate__slideInLeft" id="content">
    ...
    <div class="row justify-content-center mb-3 mt-5  ">
        <div class="col-12 d-flex justify-content-center align-items-center">
            <h3 class="tituloPagina">Mis transferencias</h3>
        </div>
    </div>
    ...
    <div class="row justify-content-center mt-3 px-5  ">
        ...
        <div class="d-flex  mt-3 justify-content-center align-items-center">
            <button type="submit" class="btn submit" data-bs-toggle="modal" data-bs-target="#myTransac">Nueva transferencia</button>
        </div>
